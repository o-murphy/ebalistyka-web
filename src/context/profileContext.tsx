...
export const ProfileProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  useEffect(() => {
    const load = async () => {
      ...
      const validJson = profileValue && profileValue !== 'null' ? profileValue : defaultProfile
      const profileValueParsed: ProfileProps = JSON.parse(validJson)
