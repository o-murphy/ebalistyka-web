...
export interface TrajectoryTargetDistanceFieldProps extends Omit<MeasureFormFieldProps, 'value' | 'suffix' | 'onValueChange'> { }


export const TrajectoryTargetDistance: React.FC<TrajectoryTargetDistanceFieldProps> = () => {
